...
from app.equipment import crud as crud_plantequipment
...
@equipmentRouter.get("/{plant_equipment_id}")
...
@equipmentRouter.get("/plant/{plant_id}")
...
@equipmentRouter.delete("/{plant_equipment_id}", response_model=Dict[str, str])
